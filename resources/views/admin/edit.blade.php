        ...
        <form method="POST" action="{{ route('admin.update', $blog->id) }}" enctype="multipart/form-data" class="admin-form">
            ...
            <div class="admin-form-group">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 5px;">
                    ...
                    <span id="slug-char-count" style="font-size: 12px; color: #6b7280; margin-left: 10px;">{{ strlen(old('slug', $blog->slug ?? '')) }}/70</span>
                </div>
                @error('slug')
            ...
            <div class="admin-form-group">
                ...
                <div style="display: flex; justify-content: flex-end; align-items: center; margin-top: 5px;">
                    <span id="title-char-count" style="font-size: 12px; color: #6b7280; margin-left: 10px;">{{ strlen(old('title', $blog->title ?? '')) }}/70</span>
                </div>
                @error('title')
                    <p class="admin-form-error">{{ $message }}</p>
                @enderror
            ...
            <div class="admin-form-group">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 5px;">
                    ...
                    <span id="excerpt-char-count" style="font-size: 12px; color: #6b7280; margin-left: 10px;">{{ strlen(old('excerpt', $blog->excerpt ?? '')) }}/160</span>
                </div>
                @error('excerpt')
                    <p class="admin-form-error">{{ $message }}</p>
                @enderror
            ...
            @if($blog->image)
                <div class="admin-form-group">
                    ...
                    <div class="admin-current-image-wrapper">
                        <img src="{{ $blog->image_url }}" alt="{{ $blog->image_alt ?? $blog->title }}" class="admin-current-image">
            ...
            <!-- Image Alt Text -->
            <div class="admin-form-group">
                <label for="image_alt" class="admin-form-label">
                    Image Alt Text
                </label>
                <input type="text"
                       name="image_alt"
